...
function mysteam_info()
{
	...
	if($db->field_exists('steamid', 'users'))
	{
		...
		{
			$mysteam_desc .=  '<li><img src="' .$mybb->settings['bburl']. '/images/valid.png"> ' .$lang->mysteam_asb_success. '</li>';
		}
		// Check if API key is provided. If not, display error.
		if (!$mybb->settings['mysteam_apikey'])
		{
			$mysteam_desc .=  '<li><img src="' .$mybb->settings['bburl']. '/images/error.png"> ' .$lang->mysteam_apikey_needed. '</li>';
		}
		...
		{
			$mysteam_desc .=  '<li><img src="' .$mybb->settings['bburl']. '/images/error.png"> ' .$lang->mysteam_steamids_needed. '</li>';
		}
		...
		{
			$mysteam_desc .= '<li><img src="' .$mybb->settings['bburl']. '/images/error.png"> ' .$lang->mysteam_asb_upgrade. '</li>';
		}
		$mysteam_desc .= '</ul>';
	}
	else
	...
	return array(
		...
		'website'		=> 'https://github.com/JonnyBoy0719/MySteam-Powered-for-MyBB-1.8.x',
		'author'		=> 'Tanweth, Updated by JonnyBoy019',
